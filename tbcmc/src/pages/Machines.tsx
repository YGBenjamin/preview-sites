...
import { Weight, Zap, ArrowRight, Search, Filter, Loader2 } from "lucide-react";
...
const Machines = () => {
  ...
  const content = {
    fr: {
      title: "Équipements de Construction à Vendre",
      subtitle: "Parcourez notre vaste collection d'équipements de construction premium. Tous les équipements sont livrés avec garantie et support professionnel.",
      searchPlaceholder: "Rechercher des machines...",
      categoryPlaceholder: "Catégorie",
      allCategories: "Toutes les Catégories",
      brandPlaceholder: "Marque",
      allBrands: "Toutes les Marques",
      resultsText: "Machines Trouvées",
      showingResults: "Affichage des résultats pour vos critères de recherche",
      inStock: "En Stock",
      preOrder: "Pré-commande",
      viewDetails: "Voir les Détails",
      noMachines: "Aucune machine trouvée",
      noMachinesDescription: "Essayez d'ajuster vos critères de recherche ou parcourez tous les équipements disponibles.",
    ...
    en: {
      title: "Construction Equipment for Sale",
      subtitle: "Browse our extensive collection of premium construction machinery. All equipment comes with warranty and professional support.",
      searchPlaceholder: "Search machines...",
      categoryPlaceholder: "Category",
      allCategories: "All Categories", 
      brandPlaceholder: "Brand",
      allBrands: "All Brands",
      resultsText: "Machines Found",
      showingResults: "Showing results for your search criteria",
      inStock: "In Stock",
      preOrder: "Pre-order",
      viewDetails: "View Details",
      noMachines: "No machines found",
      noMachinesDescription: "Try adjusting your search criteria or browse all available equipment.",
  ...
  // Get category options (static categories from DB)
  const categoryOptions = ["all", ...dbCategories.map(cat => cat.name)];

  // Filter products - only show machines (accessories = false)
          ...
          <div className="container mx-auto px-4">
                ...
                return (
                  <Card key={product.id} className="group hover:shadow-xl transition-all duration-150 cursor-pointer" onClick={() => window.location.href = `/machines/${product.id}`}>
                    ...
                    <CardContent className="p-6">
                      ...
                      <CardTitle className="text-xl mb-2">{product.name || "Machine sans nom"}</CardTitle>
                      ...
                      <div className="space-y-2 mb-4 text-sm">
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          {product.bucket_capacity && (
                            <div className="flex items-center gap-1 text-xs">
                              <span className="font-medium">Godet:</span>
                              <span>{product.bucket_capacity}</span>
                            </div>
                          )}
                          {product.max_digging_depth && (
                            <div className="flex items-center gap-1 text-xs">
                              <span className="font-medium">Prof.:</span>
                              <span>{product.max_digging_depth}</span>
                            </div>
                          )}
                        </div>
                      </div>
            ...
            {filteredProducts.length === 0 && !loading && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">{currentContent.noMachines}</h3>
                <p className="text-muted-foreground mb-4">
                  {currentContent.noMachinesDescription}
                </p>
